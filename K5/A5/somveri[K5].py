...
W3=WagirlikOkuma.Liste("W3D.txt")
...
##            break 
    ...
    habidat2[i].append(WagirlikIsleme.WagirlikIsle(cc,W3))

    dd.append(habidat[i][3])
    dd.append(habidat[i][4])
    habidat2[i].append(WagirlikIsleme.WagirlikIsle(dd,W2))

    habidat2[i].append(habidat[i][5])
