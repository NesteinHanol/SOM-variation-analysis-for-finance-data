...
W2=WagirlikOkuma.Liste("W2D.txt")
...
##            break 
    ...
    habidat2[i].append(WagirlikIsleme.WagirlikIsle(cc,W2))

    dd.append(habidat[i][2])
    dd.append(habidat[i][3])
    habidat2[i].append(WagirlikIsleme.WagirlikIsle(dd,W2))

    ee.append(habidat[i][4])
    ee.append(habidat[i][5])
    habidat2[i].append(WagirlikIsleme.WagirlikIsle(ee,W2))
